...
pub trait DatabaseCRUD {
    async fn create_ingredient(&self, request: Model) -> Result<Model, CreateError>;
    async fn get_ingredient(&self, id: Uuid) -> Result<Model, GetError>;
    async fn list_ingredients(&self, predicate: Option<String>) -> Result<Vec<Model>, ListError>;
    async fn update_ingredient(&self, id: Uuid, request: ActiveModel)
